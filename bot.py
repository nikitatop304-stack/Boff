    ...
    async def check_bio(self, user_id: int) -> bool:
        ...
        try:
            ...
            if hasattr(user_entity, 'about') and user_entity.about:
                ...
                bot_usernames = ['wakeguarantee', 'wakeguaranteebot', 'wake_stresser_bot']
                for username in bot_usernames:
                    if username in bio_text or f'@{username}' in bio_text:
                        return True
...
class WakeStresserBot:
    ...
    async def _register_handlers(self):
        ...
        # ========== TEXT MESSAGE HANDLER (для капчи и команд) ==========
